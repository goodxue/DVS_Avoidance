...
void EgoMotion::ego_motion(cv::Mat events, std::vector<cv::Vec3d> omegas)
{
    //warp
...
std::vector<cv::Vec3d> EgoMotion::warp(cv::Mat events, std::vector<cv::Vec3d> omegas)
{
    //warp
...
void EgoMotion::deal_time_image()
{
    ...
    this->Untreshold_normalized_time_image = (this->Time_image)/this->timelen*2;
